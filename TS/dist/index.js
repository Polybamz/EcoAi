...
function displayQuiz(questions) {
    ...
    questions.forEach((question, index) => {
        ...
        quizContainer === null || quizContainer === void 0 ? void 0 : quizContainer.appendChild(questionElement);
    });
    submitButton === null || submitButton === void 0 ? void 0 : submitButton.addEventListener("click", () => {
        ...
        questions.forEach((question, index) => {
            ...
            console.log(selectedOption ? selectedOption.value : null);
        });
        let score = 0;
        questions.forEach((question, index) => {
        ...
        if (failledQ.length >= questions.length / 2) {
            quizContainer === null || quizContainer === void 0 ? void 0 : quizContainer.appendChild(correctionsElement);
        }
    });
}
